...
public data class GooglePayAvailabilityCheckResponse(
    public val isAvailable: Boolean
) : ResponseBody()

public data class GooglePayAvailabilityCheckError(
    public val message: String? = null
) : ResponseBody()

public class GooglePayAvailabilityCheckResult private constructor(
    status: Int,
    body: ResponseBody?
) : Result(status, body) {
    ...
    public class Success(
        public val response: GooglePayAvailabilityCheckResponse
    )

    public class Failure(
        public val statusCode: StatusCode,
        public val response: GooglePayAvailabilityCheckError
    ) {
