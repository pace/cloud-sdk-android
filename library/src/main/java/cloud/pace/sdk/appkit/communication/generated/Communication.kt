...
public interface Communication {
     ...
     *
     * @param timeout The timeout of getBiometricStatus in milliseconds or null if no timeout should be used
     */
     ...
     *
     * @param timeout The timeout of setSecureData in milliseconds or null if no timeout should be used
     * @param setSecureDataRequest The setSecureData request body object
     */
    public suspend fun setSecureData(
        timeout: Long?,
        setSecureDataRequest: SetSecureDataRequest
    ): SetSecureDataResult
     ...
     *
     * @param timeout The timeout of getSecureData in milliseconds or null if no timeout should be used
     * @param getSecureDataRequest The getSecureData request body object
     */
    public suspend fun getSecureData(
        timeout: Long?,
        getSecureDataRequest: GetSecureDataRequest
    ): GetSecureDataResult
     ...
     *
     * @param timeout The timeout of openURLInNewTab in milliseconds or null if no timeout should be used
     ...
     *
     * @param timeout The timeout of verifyLocation in milliseconds or null if no timeout should be used
     * @param verifyLocationRequest The verifyLocation request body object
     */
    public suspend fun verifyLocation(
        timeout: Long?,
     ...
     *
     * @param timeout The timeout of getAccessToken in milliseconds or null if no timeout should be used
     ...
     */
    public suspend fun imageData(
        timeout: Long?,
        imageDataRequest: ImageDataRequest
    ): ImageDataResult

    /**
     * Requests, if Apple Pay is ready to be used (enabled + cards onboarded; iOS only)
     *
     * @param timeout The timeout of applePayAvailabilityCheck in milliseconds or null if no timeout should be used
     ...
     *
     * @param timeout The timeout of appInterceptableLink in milliseconds or null if no timeout should be used
     */
     ...
     *
     * @param timeout The timeout of setUserProperty in milliseconds or null if no timeout should be used
     ...
     */
    public suspend fun appRedirect(
        timeout: Long?,
        appRedirectRequest: AppRedirectRequest
    ): AppRedirectResult

    /**
     * Checks if biometric authentication is enabled.
     *
     * @param timeout The timeout of isBiometricAuthEnabled in milliseconds or null if no timeout should be used
     */
     ...
     *
     * @param timeout The timeout of isRemoteConfigAvailable in milliseconds or null if no timeout should be used
     */
     ...
     *
     * @param timeout The timeout of googlePayAvailabilityCheck in milliseconds or null if no timeout should be used
     ...
     *
     * @param timeout The timeout of googlePayPayment in milliseconds or null if no timeout should be used
     ...
     *
     * @param timeout The timeout of startNavigation in milliseconds or null if no timeout should be used
     ...
     */
    public suspend fun receiptEmail(
        timeout: Long?,
        receiptEmailRequest: ReceiptEmailRequest
    ): ReceiptEmailResult

    /**
     * Asks the client for optional attachments to be included in the fueling receipt.
     *
     * @param timeout The timeout of receiptAttachments in milliseconds or null if no timeout should be used
