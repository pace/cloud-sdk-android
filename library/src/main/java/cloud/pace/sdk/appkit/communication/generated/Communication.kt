...
public interface Communication {
   ...
   */
  public suspend fun openURLInNewTab(timeout: Long?,
      openURLInNewTabRequest: OpenURLInNewTabRequest): OpenURLInNewTabResult
   ...
   */
  public suspend fun applePayRequest(timeout: Long?,
      applePayRequestRequest: ApplePayRequestRequest): ApplePayRequestResult
   ...
   */
  public suspend fun setUserProperty(timeout: Long?,
      setUserPropertyRequest: SetUserPropertyRequest): SetUserPropertyResult
