...
data class CustomOIDConfiguration @JvmOverloads constructor(
    ...
    val tokenRevocationEndpoint: String? = null,
...
fun CustomOIDConfiguration.oidConfiguration(environment: Environment) =
    when (environment) {
        Environment.PRODUCTION -> OIDConfiguration(
            ...
            tokenRevocationEndpoint = tokenRevocationEndpoint ?: "https://id.pace.cloud/auth/realms/pace/protocol/openid-connect/revoke",
        ...
        Environment.SANDBOX -> OIDConfiguration(
            ...
            tokenRevocationEndpoint = tokenRevocationEndpoint ?: "https://id.sandbox.pace.cloud/auth/realms/pace/protocol/openid-connect/revoke",
            clientSecret = clientSecret,
            scopes = scopes,
            redirectUri = redirectUri,
            responseType = responseType,
        ...
        Environment.DEVELOPMENT -> OIDConfiguration(
            ...
            tokenRevocationEndpoint = tokenRevocationEndpoint ?: "https://id.dev.pace.cloud/auth/realms/pace/protocol/openid-connect/revoke",
            clientSecret = clientSecret,
            scopes = scopes,
            redirectUri = redirectUri,
            responseType = responseType,
