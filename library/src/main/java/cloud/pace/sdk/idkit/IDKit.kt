...
object IDKit : IDKitKoinComponent {
     ...
     */
    fun authorize(completedActivity: Class<*>, canceledActivity: Class<*>) = authorizationManager.authorize(completedActivity, canceledActivity)
     ...
     */
    fun authorize(): Intent = authorizationManager.authorize()
     ...
     */
    fun endSession(completedActivity: Class<*>, canceledActivity: Class<*>) = authorizationManager.endSession(completedActivity, canceledActivity)
     ...
     */
    fun isAuthorizationValid() = authorizationManager.isAuthorizationValid()
     ...
     */
    fun containsAuthorizationResponse(intent: Intent) = authorizationManager.containsAuthorizationResponse(intent)
     ...
     */
    fun containsEndSessionResponse(intent: Intent) = authorizationManager.containsEndSessionResponse(intent)
     ...
     */
    fun containsException(intent: Intent) = authorizationManager.containsException(intent)

    /**
     * Returns the cached accessToken of the current session or null if the session is not initialized or has no accessToken.
     */
    fun cachedToken() = authorizationManager.cachedToken()
     ...
     */
    fun isBiometricAuthenticationEnabled() = credentialsManager.isBiometricAuthenticationEnabled()
     ...
     */
    fun disableBiometricAuthentication() = credentialsManager.disableBiometricAuthentication()
