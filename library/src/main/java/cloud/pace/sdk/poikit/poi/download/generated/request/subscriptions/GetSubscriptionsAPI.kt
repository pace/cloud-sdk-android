...
package cloud.pace.sdk.api.request.subscriptions
...
private val service: GetSubscriptionsService by lazy {
    Retrofit.Builder()
...
fun API.SubscriptionsAPI.getSubscriptions(): Call<Subscription> {
