...
package cloud.pace.sdk.api.request.priceHistories
...
fun API.PriceHistoriesAPI.getPriceHistory(id: String, fuelType: Fuel? = null, filterfrom: Date? = null, filterto: Date? = null, filtergranularity: String? = null): Call<PriceHistory> {
    return service.getPriceHistory(id, fuelType, filterfrom?.toIso8601()?.dropLast(9)+'Z' , filterto?.toIso8601()?.dropLast(9)+'Z' , filtergranularity)
}
