 ...
 */
    ...
    class Body {
        ...
        var data: PaymentMethodSepaCreate? = null
    }

    private val service: CreatePaymentMethodSEPAService by lazy {
        Retrofit.Builder()
    ...
    fun PayAPI.NewPaymentMethodsAPI.createPaymentMethodSEPA(body: Body) =
        service.createPaymentMethodSEPA(body)
}
