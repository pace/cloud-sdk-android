 ...
 */
    ...
    fun PayAPI.NewPaymentMethodsAPI.createPaymentMethodRoadrunner(body: Body, readTimeout: Long? = null, additionalHeaders: Map<String, String>? = null, additionalParameters: Map<String, String>? = null): Call<PaymentMethod> {
        ...
        return service.createPaymentMethodRoadrunner(headers, body)
    }
}
