 ...
 */
    ...
    private val service: CancelPreAuthPaymentService by lazy {
        Retrofit.Builder()
    ...
    fun PayAPI.PaymentTransactionsAPI.cancelPreAuthPayment(transactionId: String) =
        service.cancelPreAuthPayment(transactionId)
}
