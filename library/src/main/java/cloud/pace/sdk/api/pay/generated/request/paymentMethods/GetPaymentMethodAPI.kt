...
object GetPaymentMethodAPI {
    ...
    private val service: GetPaymentMethodService by lazy {
        Retrofit.Builder()
    ...
    fun PayAPI.PaymentMethodsAPI.getPaymentMethod(paymentMethodId: String) =
        service.getPaymentMethod(paymentMethodId)
}
