 ...
 */
    ...
    fun PayAPI.NewPaymentMethodsAPI.createPaymentMethodRMC(body: Body, readTimeout: Long? = null, additionalHeaders: Map<String, String>? = null, additionalParameters: Map<String, String>? = null): Call<PaymentMethod> {
        ...
        val service: CreatePaymentMethodRMCService =
            Retrofit.Builder()
                .client(client.build())
        ...
        return service.createPaymentMethodRMC(headers, body)
    }
}
