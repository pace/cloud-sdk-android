 ...
 */
    ...
    class Body {
        ...
        var data: TransactionCreate? = null
    }

    private val service: ProcessPaymentService by lazy {
        Retrofit.Builder()
    ...
    fun PayAPI.PaymentTransactionsAPI.processPayment(announce: Boolean? = null, body: Body) =
        service.processPayment(announce, body)
}
