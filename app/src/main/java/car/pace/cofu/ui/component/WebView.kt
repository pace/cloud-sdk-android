...
import car.pace.cofu.ui.component.LoadingState.Finished
import car.pace.cofu.ui.component.LoadingState.Loading
...
): WebViewNavigator = remember(coroutineScope) { WebViewNavigator() }
