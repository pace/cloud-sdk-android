...
object Constants {
    ...
    const val DETAIL_PRICE_LIST_TITLE_KEY = "DetailPriceListTitle"
    const val DETAIL_EMPTY_PRICES_KEY = "DetailEmptyPrices"
    ...
    const val DETAIL_PRICE_LIST_TITLE_CONTENT_TYPE = "DetailPriceListTitle"
    const val DETAIL_EMPTY_PRICES_CONTENT_TYPE = "DetailEmptyPrices"
    const val DETAIL_SPACER_CONTENT_TYPE = "DetailSpacer"
    const val DETAIL_PRICE_ITEM_CONTENT_TYPE = "DetailPriceItem"
    const val DETAIL_LAST_UPDATED_CONTENT_TYPE = "DetailLastUpdated"
}
