object Libs {
    ...
    const val KOIN_ANDROID_COMPOSE = "io.insert-koin:koin-androidx-compose:${Versions.KOIN_ANDROID_COMPOSE}"
    ...
    // We can't use Jetpack Compose BOM, because otherwise the versions of the Compose dependencies in the pom.xml file are null
    const val JETPACK_COMPOSE_ANIMATION = "androidx.compose.animation:animation:${Versions.JETPACK_COMPOSE}"
    ...
    const val JETPACK_COMPOSE_FOUNDATION = "androidx.compose.foundation:foundation:${Versions.JETPACK_COMPOSE}"
    ...
    const val LIFECYCLE_RUNTIME_COMPOSE_KTX = "androidx.lifecycle:lifecycle-runtime-compose:${Versions.LIFECYCLE_KTX}"
