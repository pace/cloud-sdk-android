object Libs {
    ...
    const val MOSHI_JSONAPI = "moe.banana:moshi-jsonapi:${Versions.MOSHI_JSONAPI}"
    const val MOSHI_JSONAPI_RETROFIT_CONVERTER = "moe.banana:moshi-jsonapi-retrofit-converter:${Versions.MOSHI_JSONAPI}"
